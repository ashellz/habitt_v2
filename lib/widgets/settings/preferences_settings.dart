            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  NewDefaultSwitch(
                    onChanged: (value) {
                      context.read<PreferencesProvider>().setShowUploadActivity(
                        value,
                      );
                    },
                    value:
                        context.watch<PreferencesProvider>().showUploadActivity,
                  ),
                ],
              ),
              Divider(color: cp.border, height: 32),
                ...
                children: [
                  ...
                  NewDefaultSwitch(
                    onChanged: (value) {
                      context
                          .read<PreferencesProvider>()
                          .setShowStreakCelebration(value);
                    },
                    value:
                        context
