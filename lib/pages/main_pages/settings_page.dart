        ...
        child: ListView(
          children: [
            ...
            Padding(
              ...
              child: Column(
                spacing: 10,
                children: [LanguageSetting(), AppearanceSetting()],
              ),
            ),
          ],
        ),
...
class _AppearanceSettingState extends State<AppearanceSetting> {
  ...
  void setMode(ColorMode mode, ColorProvider cp) {
    if (cp.mode != mode) {
      cp.setMode(mode);
    }
  }
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Padding(padding: const EdgeInsets.all(2), child: preview),
            ),
            AnimatedContainer(
