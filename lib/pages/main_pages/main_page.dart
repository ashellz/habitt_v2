...
class HabitsPageTopSection extends StatefulWidget {
  const HabitsPageTopSection({super.key});

  @override
  State<HabitsPageTopSection> createState() => _HabitsPageTopSectionState();
}

class _HabitsPageTopSectionState extends State<HabitsPageTopSection> {
  String? name;
