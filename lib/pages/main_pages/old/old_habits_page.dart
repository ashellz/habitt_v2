...
import 'package:habitt/pages/main_pages/old/daily_plan_page.dart';
import 'package:habitt/pages/other_pages/old_add_habit_page.dart';
...
class OldHabitsPage extends StatefulWidget {
  const OldHabitsPage({super.key});

  @override
  State<OldHabitsPage> createState() => _OldHabitsPageState();
}

class _OldHabitsPageState extends State<OldHabitsPage>
